package com.bacardi.domain.core;
...
public class BaUser implements UserDetails {
	...
	*/
	...
	public BaUser(String firstName, String lastName) {
		super();
    ...
    private Set<BaAuthority>  roles = new HashSet<BaAuthority>();;
    @Column
	...
	public Set<BaAuthority> getRoles() {
		return roles;
	}

	public void setRoles(Set<BaAuthority> roles) {
		this.roles = roles;
	}
